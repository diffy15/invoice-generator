...
export const companyAPI = {
  ...
  getAllFYTargets:   ()         => api.get('/company/fy-targets'),
  getFYTargets:     (fy)       => api.get(`/company/fy-targets/${fy}`),
  saveFYTargets:    (fy, data) => api.put(`/company/fy-targets/${fy}`, data),
  deleteFYTargets:  (fy)       => api.delete(`/company/fy-targets/${fy}`),
};
...
export const invoiceAPI = {
  ...
  // fy = FY start year number e.g. 2024 → fetches revenue for FY 2024-25
  // If not passed, backend defaults to current FY
